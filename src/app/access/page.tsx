  ...
  return (
    <PublicShell salonName={settings.salon_name}>
      <div className="space-y-5">
        ...
        {settings.map_url ? (
          <Link className="block rounded-full bg-black px-5 py-3 text-center text-sm font-medium text-white transition hover:bg-stone-800" href={settings.map_url} target="_blank">
            Googleマップで見る
          </Link>
        ) : null}
      </div>
